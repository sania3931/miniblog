...
class CategoryController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($category) {
            return redirect('Admin/categories')->with('success', __("alert.yourDeleteCategoryrIsSuccessfully"));
        } else {
            return redirect('Admin/categories')->with('error', __("alert.yourDeleteCategoryIsFailed"));
        }
    }
}
